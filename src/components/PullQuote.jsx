	...
	return (
		...
		>
			<div className="quote__media" aria-hidden="true">
				<img
					src={`${import.meta.env.BASE_URL}assets/water-1600.jpg`}
					srcSet={`${import.meta.env.BASE_URL}assets/water-900.jpg 900w, ${import.meta.env.BASE_URL}assets/water-1600.jpg 1600w`}
					sizes="100vw"
					width="1600"
					height="688"
					alt=""
